  ...
  return (
    <div ref={containerRef} className={cn("relative w-full", className)}>
      ...
      <button
        ...
        className={cn(
          "w-full h-10 px-3 py-2 text-left bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md shadow-2xs flex items-center justify-between text-sm transition-all focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:border-blue-500",
        ...
        <div className="absolute z-50 left-0 right-0 mt-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg shadow-lg overflow-hidden animate-in fade-in-50 zoom-in-95 duration-100">
          ...
          <div className="p-2 border-b border-slate-100 dark:border-slate-800 flex items-center bg-slate-50/50 dark:bg-slate-900/50">
            ...
            <input
              ...
              className="w-full bg-transparent text-xs text-slate-900 dark:text-slate-100 placeholder:text-slate-400 focus:outline-hidden py-1"
            />
            {search && (
              <button
                type="button"
